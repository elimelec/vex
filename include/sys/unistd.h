/**
*** static char sccs_id[] = "$Id: unistd.h,v 1.1.1.1 2001/11/21 20:34:39 frb Exp $ ";
**/
...
int     _EXFUN(gethostname, (char *hostname, size_t size));
...
char*   _EXFUN(realpath, (const char *file_name, char *resolved_name));
...
#ifdef __CYGWIN32__
int     _EXFUN(ftruncate, (int fd, size_t length));
#endif
