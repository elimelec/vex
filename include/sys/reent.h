/**
*** static char sccs_id[] = "$Id: reent.h,v 1.2 2001/11/29 00:51:40 frb Exp $ ";
**/
...
#define _N_LISTS 30
  ...
  struct sigaction _sig_act[NSIG - 1]; /* signal handlers */
  sigset_t _current_signal;            /* pending signals */
  sigset_t _current_blocked;           /* blocked signals */
...
#ifdef __CYGWIN32__
/* cygwin32 already uses newlib, so we need another symbol */
