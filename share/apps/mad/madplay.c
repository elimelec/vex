 ...
 *
 * $Id: madplay.c,v 1.2 2009/12/17 11:04:43 frb Exp $
 */
...
extern int xstrncasecmp(char const *str1, char const *str2, unsigned long len)
{
...
extern int xstrcasecmp(char const *str1, char const *str2)
{
  signed int c1, c2;
