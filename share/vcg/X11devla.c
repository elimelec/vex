...
#ifndef lint
static char *id_string="$Id: X11devla.c,v 1.2 2009/12/17 17:07:29 frb Exp $";
#endif
...
#endif
{
	...
	okay_button   = allocate_general_button(490,164,(BUTTON_W - 10)/2,25);
	apply_button  = allocate_general_button(420,164,(BUTTON_W - 10)/2,25);
}
...
#endif
{
	...
	for (i=0; i<MAX_HSCROLLBARS; i++) {
        ...
        XMapRaised(root_display, apply_button);
	normalize_point(okay_button);
	normalize_point(cancel_button);
	normalize_point(apply_button);
...
#endif
{
	...
	if ((w==okay_button)||(w==cancel_button)||(w==apply_button)) is_point = 1;
