...
/* $Id: alloc.h,v 1.2 2009/12/17 17:07:29 frb Exp $ */
...
typedef struct gnode {	
	...
	long	sxloc;
	long 	syloc;
	signed char	textmode;
	signed char	borderwidth;
	char	folding;
	signed char	color;
	signed char	textcolor;
	signed char	bordercolor;
	signed char	status;
	signed char 	shape;
	int	shrink;
	int	stretch;
...
typedef struct gedge {
	...
	signed char	linestyle;
	signed char	thickness;
	char	*label;
	int	priority;
	int	horder;
	signed char	eclass;
	signed char	color;
	signed char 	arrowstyle1;	
	signed char 	arrowstyle2;	
	signed char	arrowsize1;
	signed char	arrowcolor1;
	signed char	arrowsize2;
	signed char	arrowcolor2;
	signed char	labelcolor;
