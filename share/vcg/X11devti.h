...
/* $Id: X11devti.h,v 1.2 2009/12/17 17:07:29 frb Exp $ */
...
void 	x11_init_title_dialog	  _PP((Display *rd, int rs));
void	x11_destroy_title_dialog  _PP((Display *rd, int rs));
GNODE   x11_print_title_dialog    _PP(());
